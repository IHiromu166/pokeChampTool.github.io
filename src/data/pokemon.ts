...
export const POKEMON: PokemonSpecies[] = [
  ...
  // 026 ライチュウ
  {
    ...
    weight: 0,
    megas: [
      { key: "x", id: "raichu-mega-x", label: "メガ X", stone: "ライチュウナイトX" },
      { key: "y", id: "raichu-mega-y", label: "メガ Y", stone: "ライチュウナイトY" },
    ],
  },
  {
    id: "raichu-alola",
  ...
  // 518 ムシャーナ
  {
    ...
    name: "ムシャーナ",
    types: ["エスパー"],
    baseStats: { hp: 116, atk: 107, def: 95, spa: 135, spd: 95, spe: 29 },
    abilities: ["ふゆう", "シンクロ", "テレパシー"],
    weight: 0,
  },
  // 545 ペンドラー
  {
  ...
  // 687 カラマネロ
  {
    ...
    abilities: ["さかさまのおきて", "すいすい", "かがくのちから"],
    weight: 0,
    mega: "malamar-mega",
    megaStone: "カラマネロナイト",
  },
  ...
  // 689 ガメノデス
  {
    ...
    abilities: ["タフネス", "きれあじ", "すなあつめ"],
    weight: 0,
    mega: "barbaracle-mega",
    megaStone: "ガメノデスナイト",
  },
  {
    id: "barbaracle-mega",
  ...
  // 691 ドラミドロ
  {
    ...
    abilities: ["どくのとげ", "てきおうりょく", "うるおいボディ"],
    weight: 0,
    mega: "dragalge-mega",
    megaStone: "ドラミドロナイト",
  },
